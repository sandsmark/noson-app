...
HEADERS += ../backend/modules/NosonApp/qmlfilterbehavior.h
HEADERS += ../backend/modules/NosonApp/qmlsortbehavior.h
HEADERS += ../backend/modules/NosonApp/qmlsortfiltermodel.h
HEADERS += ../backend/modules/NosonApp/allservicesmodel.h
...
SOURCES += ../backend/modules/NosonApp/qmlfilterbehavior.cpp
SOURCES += ../backend/modules/NosonApp/qmlsortbehavior.cpp
SOURCES += ../backend/modules/NosonApp/qmlsortfiltermodel.cpp
SOURCES += ../backend/modules/NosonApp/allservicesmodel.cpp
